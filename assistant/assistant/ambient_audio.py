...
DEFAULT_EVENT_REACTIONS = {
    "glass_break": {
        "severity": "critical",
        "message_de": "Glasbruch erkannt in {room}!",
        "sound_event": "alarm",
        "actions": ["lights_on", "notify_owner"],
    },
    "smoke_alarm": {
        "severity": "critical",
        "message_de": "Rauchmelder ausgeloest in {room}!",
        "sound_event": "alarm",
        "actions": ["lights_on", "notify_all"],
    },
    "co_alarm": {
        "severity": "critical",
        "message_de": "CO-Melder Alarm in {room}! Sofort lueften und Raum verlassen!",
        "sound_event": "alarm",
        "actions": ["lights_on", "notify_all"],
    },
    "dog_bark": {
        "severity": "info",
        "message_de": "Der Hund bellt{room_suffix}.",
        "sound_event": None,
        "actions": ["notify_owner"],
    },
    "baby_cry": {
        "severity": "high",
        "message_de": "Das Baby weint{room_suffix}.",
        "sound_event": "warning",
        "actions": ["notify_owner"],
    },
    "doorbell": {
        "severity": "info",
        "message_de": "Es klingelt an der Tuer.",
        "sound_event": "doorbell",
        "actions": ["notify_present"],
    },
    "gunshot": {
        "severity": "critical",
        "message_de": "Lauter Knall erkannt{room_suffix}! Bitte Situation pruefen.",
        "sound_event": "alarm",
        "actions": ["lights_on", "notify_all"],
    },
    "water_alarm": {
        "severity": "high",
        "message_de": "Wasseralarm in {room}! Moeglicher Wasseraustritt.",
        "sound_event": "alarm",
        "actions": ["notify_owner"],
    },
    "scream": {
        "severity": "high",
        "message_de": "Schrei erkannt{room_suffix}! Ist alles in Ordnung?",
        "sound_event": "warning",
        "actions": ["notify_present"],
    },
}
