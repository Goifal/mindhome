...
app.json.ensure_ascii = False  # Fix: Allow UTF-8 in JSON responses (umlauts)
...
@app.route("/api/energy/standby-config/<int:sc_id>", methods=["PUT"])
...
@app.route("/api/energy/standby-config/<int:sc_id>", methods=["DELETE"])
...
@app.route("/api/energy/discover-sensors", methods=["GET"])
...
@app.route("/api/scenes/suggestions", methods=["GET"])
...
def api_get_sun():
    return jsonify(ha.get_sun_data() if hasattr(ha, 'get_sun_data') else {"error": "not available"})
...
@app.route("/api/holidays/seed-defaults", methods=["POST"])
...
# ==============================================================================
# Phase 3: Default Presence Modes Seeder
# ==============================================================================

@app.route("/api/presence-modes/seed-defaults", methods=["POST"])
